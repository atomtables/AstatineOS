...
//  */
// void __write_char_move__(const int x, int y, const char character) {
//     if (x >= VGA_TEXT_WIDTH) return;
...
//             memcpy((void*)0xb8000 + i * VGA_TEXT_WIDTH * 2, (void*)0xb8000 + (i + 1) * VGA_TEXT_WIDTH * 2,
//                    VGA_TEXT_WIDTH * 2);
//         }
...
//  */
// void __write_char_color_move__(const int x, int y, const char character, const u8 color) {
//     if (x >= VGA_TEXT_WIDTH) return;
//     if (y >= VGA_TEXT_HEIGHT) {
//         y = VGA_TEXT_HEIGHT - 1;
//         for (int i = 0; i < VGA_TEXT_HEIGHT - 1; i++) {
...
//  * @param color The color to write.
//  */
// void __write_color_move__(const int x, int y, const u8 color) {
//     if (x >= VGA_TEXT_WIDTH) return;
//     if (y >= VGA_TEXT_HEIGHT) {
//         y = VGA_TEXT_HEIGHT - 1;
//         for (int i = 0; i < VGA_TEXT_HEIGHT - 1; i++) {
...
// }
//
// void __write_string__(int x, int y, char* str) {
//     for (int i = 0; str[i] != '\0'; i++) {
//         __write_char__(x, y, str[i]);
//         x++;
//     }
// }
//
// void __write_string_color__(int x, int y, char* str, const u8 color) {
//     for (int i = 0; str[i] != '\0'; i++) {
//         __write_char_color_move__(x, y, str[i], color);
//         x++;
//     }
// }
//
...
//     __write_char_move__(display_data.x, display_data.y, character);
//
//     __inc_displaydata__();
...
//     __write_char_color_move__(display_data.x, display_data.y, character, color);
//
//     __inc_displaydata__();
//     __set_vga_cursor_pos__(display_data.x, display_data.y);
// }
...
//     }
//
//     __write_char_move__(display_data.x, display_data.y, 0);
// }
//
// /**
...
//  */
// void change_screen_color(const u8 color) { memset_step((void*)0xb8001, color, VGA_TEXT_SIZE, 2); }
//
// /**
